	...
	<div class="container">
		...
		<form action="/sale/update_sale_data/{{$customer->id }}" method="POST" class="form-horizontal">
			...
			<div class="panel panel-default">
				<div class="panel-heading">Edit Sales Details</div>
					...
					*/ ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<div class="form-group row">
								<div class="col-xs-3">
									<input type="text" class="form-control" name="street_address2" placeholder="Street Address Line 2" value="{{ $address->street_address2  }}" >
								</div>
								<div class="col-xs-6"> &nbsp; </div>							 
							</div>
							<div class="form-group row">
